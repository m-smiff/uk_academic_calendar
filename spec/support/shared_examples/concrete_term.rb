...
RSpec.shared_examples 'concrete term class' do
  describe '#hash' do
    include_context 'for random academic year'
  ...
  describe '#eql?' do
    ...
    context 'other of different class' do
      let(:other) do
  ...
  describe '#start_date=' do
    ...
    context 'val is out of bounds' do
      let(:new_start_date) { assert_nominal_start_date - 5 }
      it do
        expect { subject.start_date = new_start_date }
          .to raise_error(
  ...
  describe '#to_range' do
    ...
    context '#start_date && #end_date assigned' do
